...
export declare function Header({ ariaDescription, ariaTitle, docs, selectTelescope, storage, showHelp, testId, title, toolTip, useBrowserStorage, useSymbol, children, }: HeaderProps): JSX.Element;
