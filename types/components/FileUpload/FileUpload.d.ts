...
export declare function FileUpload({ buttonSize, chooseColor, chooseDisabled, chooseFileTypes, chooseLabel, chooseToolTip, chooseVariant, direction, file, hideFileName, maxFileWidth, setFile, setStatus, status, testId, clearLabel, clearToolTip, clearVariant, uploadColor, uploadDisabled, uploadFunction, uploadLabel, uploadToolTip, uploadURL, uploadVariant, }: FileUploadProps): React.JSX.Element;
export {};
