...
export function getColors({
  ...
  const paletteMap: Record<string, Record<string, [string, string]>> = {
    ...
    status: {
      ...
      'in progress': [paletteSet.colors[COLOR_ORANGE], paletteSet.textColors[COLOR_ORANGE]],
      executing: [paletteSet.colors[COLOR_ORANGE], paletteSet.textColors[COLOR_ORANGE]],
