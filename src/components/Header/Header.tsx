...
export function Header({
  ...
  const { help, helpToggle, telescope, themeMode, toggleTheme, updateTelescope } = storageObject.useStore();
      ...
      <Grid m={1} container alignItems="center" direction="row" justifyContent="space-between">
        ...
        <Grid item>
          <Box mr={1} display="flex" justifyContent="flex-end">
            {selectTelescope && <TelescopeSelector telescope={telescope} updateTelescope={updateTelescope} />}
            {docs?.url && (
